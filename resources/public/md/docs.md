...
Two middleware functions by default which are are located in the `graffiti.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `graffiti.handler` namespace to manage the enabled middleware.
